...
public class UDPConnect implements Connector {
    ...
    private NetworkStageThread receiver;

    /** The thread that sends messages */
    private NetworkStageThread sender;
    ...
    public UDPConnect(Activity activity, String filterPort,String phoneNumber){
        inetSocketAddress = new InetSocketAddress(Number2IPv6(phoneNumber), Integer.parseInt(filterPort));
    ...
    public final synchronized void start() throws IOException {
        ...
        running = true;
        sender = new NetworkStageThread("UDP-Sender" ) {
            @Override
        ...
        receiver = new NetworkStageThread("UDP-Receiver") {
            @Override
            protected void work() throws Exception {
    ...
    private void sendMessage(final UserDatagramPacket message){
        ...
        if(message.getSmsSocketAddress() != null){
            ...
            System.out.println("UDP长度:"+message.getData().length);
