 ...
 ******************************************************************************/
package cf.core.network.deduplication;
...
public class SweepDeduplicator implements Deduplicator {
	 ...
	 * of milliseconds</li>
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#MARK_AND_SWEEP_INTERVAL} -
	 * the interval at which to check for expired exchanges in milliseconds</li>
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#DEDUPLICATOR_AUTO_REPLACE} -
