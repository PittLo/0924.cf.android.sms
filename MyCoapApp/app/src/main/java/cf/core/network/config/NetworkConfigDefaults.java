 ...
 ******************************************************************************/
package cf.core.network.config;

import cf.core.coap.CoAP;
import cf.core.network.GroupedMessageIdTracker;
...
public class NetworkConfigDefaults {
	...
	public static void setDefaults(final NetworkConfig config) {
		...
		config.setInt(Keys.ACK_TIMEOUT, 80000);
		...
		config.setString(Keys.CONGESTION_CONTROL_ALGORITHM, "Cocoa"); // see cf.core.network.stack.congestioncontrol
