...
import cf.core.coap.InternalMessageObserverAdapter;
import cf.core.coap.Message;
import cf.core.coap.Message.OffloadMode;
import cf.core.coap.MessageFormatException;
import cf.core.coap.MessageObserver;
import cf.core.coap.Request;
import cf.core.coap.Response;
import cf.core.coap.Token;
import cf.core.network.EndpointManager.ClientMessageDeliverer;
import cf.core.network.Exchange.Origin;
import cf.core.network.config.NetworkConfig;
import cf.core.network.config.NetworkConfig.Keys;
import cf.core.network.config.NetworkConfigDefaults;
import cf.core.network.interceptors.MessageInterceptor;
import cf.core.network.serialization.DataParser;
import cf.core.network.serialization.DataSerializer;
import cf.core.network.serialization.TcpDataParser;
import cf.core.network.serialization.TcpDataSerializer;
import cf.core.network.serialization.UdpDataParser;
import cf.core.network.serialization.UdpDataSerializer;
import cf.core.network.stack.BlockwiseLayer;
import cf.core.network.stack.CoapStack;
import cf.core.network.stack.CoapTcpStack;
import cf.core.network.stack.CoapUdpStack;
import cf.core.network.stack.ExchangeCleanupLayer;
import cf.core.network.stack.ObserveLayer;
import cf.core.network.stack.ReliabilityLayer;
import cf.core.observe.InMemoryObservationStore;
import cf.core.observe.NotificationListener;
import cf.core.observe.ObservationStore;
import cf.core.server.MessageDeliverer;
import cf.elements.AddressEndpointContext;
import cf.elements.Connector;
import cf.elements.EndpointContext;
import cf.elements.EndpointContextMatcher;
import cf.elements.MessageCallback;
import cf.elements.RawData;
import cf.elements.RawDataChannel;
import cf.elements.UDPConnector;
