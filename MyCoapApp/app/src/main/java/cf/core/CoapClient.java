...
import cf.core.coap.LinkFormat;
import cf.core.coap.MediaTypeRegistry;
...
import cf.core.network.EndpointManager;
...
public class CoapClient {
	 ...
	 * {@link cf.core.network.config.NetworkConfig.Keys#EXCHANGE_LIFETIME}
	...
	private class MessageObserverImpl extends MessageObserverAdapter {
		 ...
		 * 
		 * @see
		 * cf.core.coap.MessageObserverAdapter#responded(
		 * cf.core.coap.Response)
		 */
		@Override
