...
import cf.scandium.util.ServerName;
import cf.scandium.util.ServerName.NameType;
...
public final class DTLSSession implements Destroyable {
	...
	private volatile long receiveWindowUpperCurrent = RECEIVE_WINDOW_SIZE-1;
	...
	private void resetReceiveWindow() {
		...
		receiveWindowUpperCurrent = RECEIVE_WINDOW_SIZE - 1;
