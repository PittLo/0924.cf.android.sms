...
import cf.elements.auth.ExtensiblePrincipal;
import cf.elements.auth.PreSharedKeyIdentity;
...
import cf.scandium.auth.AdvancedApplicationLevelInfoSupplier;
...
public abstract class Handshaker implements Destroyable {
	...
	public void sendFlight(DTLSFlight flight) {
		...
		try {
			System.out.println("retransmissionTimeout:"+retransmissionTimeout);
