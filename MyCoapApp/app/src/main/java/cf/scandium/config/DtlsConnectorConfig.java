...
import cf.elements.util.Asn1DerDecoder;
import cf.elements.util.CertPathUtil;
import cf.elements.util.SslContextUtil;
import cf.elements.util.StringUtil;
import cf.scandium.ConnectionListener;
import cf.scandium.DtlsHealth;
import cf.scandium.auth.ApplicationLevelInfoSupplier;
import cf.scandium.dtls.CertificateMessage;
import cf.scandium.dtls.CertificateRequest;
...
import cf.scandium.dtls.SignatureAndHashAlgorithm;
import cf.scandium.dtls.cipher.CipherSuite;
import cf.scandium.dtls.cipher.CipherSuite.KeyExchangeAlgorithm;
import cf.scandium.dtls.cipher.CipherSuiteSelector;
import cf.scandium.dtls.cipher.DefaultCipherSuiteSelector;
import cf.scandium.dtls.cipher.XECDHECryptography.SupportedGroup;
import cf.scandium.dtls.pskstore.AdvancedInMemoryPskStore;
import cf.scandium.dtls.pskstore.AdvancedPskStore;
import cf.scandium.dtls.pskstore.PskStore;
...
import cf.scandium.dtls.x509.CertificateVerifier;
import cf.scandium.dtls.x509.BridgeCertificateVerifier;
import cf.scandium.util.ListUtils;
...
public final class DtlsConnectorConfig {
	 ...
	 */
	public static final int DEFAULT_RETRANSMISSION_TIMEOUT_MS = 60000;
	/**
	 * The default value for the <em>maxRetransmissions</em> property.
	 */
	public static final int DEFAULT_MAX_RETRANSMISSIONS = 2;
	/**
	 ...
	 * server name to the CoAP stack in the {@link cf.elements.EndpointContext}.
	 * 
	 ...
	 * {@link SessionCache#get(cf.scandium.dtls.SessionId)}.
