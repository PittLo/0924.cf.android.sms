...
import cf.core.coap.CoAP.Code;
import cf.core.coap.CoAP.ResponseCode;
import cf.core.coap.CoAP.Type;
import cf.core.coap.Response;
import cf.core.network.Endpoint;
import cf.core.network.Exchange;
import cf.core.observe.ObserveNotificationOrderer;
import cf.core.observe.ObserveRelation;
import cf.core.observe.ObserveRelationContainer;
import cf.core.observe.ObserveRelationFilter;
import cf.core.server.ServerMessageDeliverer;
import cf.core.server.resources.CoapExchange;
import cf.core.server.resources.Resource;
import cf.core.server.resources.ResourceAttributes;
import cf.core.server.resources.ResourceObserver;
...
public  class CoapResource implements Resource {
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#add(cf.core.server.resources.Resource)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#delete(cf.core.server.resources.Resource)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getParent()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#setParent(cf.core.server.resources.Resource)
	 */
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getChild(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#addObserver(cf.core.server.resources.ResourceObserver)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#removeObserver(cf.core.server.resources.ResourceObserver)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getAttributes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#isCachable()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getPath()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getURI()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#setPath(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#setName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#isVisible()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#isObservable()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#addObserveRelation(cf.core.observe.ObserveRelation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#removeObserveRelation(cf.core.observe.ObserveRelation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getChildren()
	 */
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getExecutor()
	 */
	...
	/* (non-Javadoc)
	 * @see cf.core.server.resources.Resource#getEndpoints()
	 */
