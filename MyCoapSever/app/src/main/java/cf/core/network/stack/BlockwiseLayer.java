...
import cf.core.coap.BlockOption;
...
import cf.core.coap.MessageObserverAdapter;
import cf.core.coap.OptionSet;
...
public class BlockwiseLayer extends AbstractLayer {
	 ...
	 * <ul>
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#MAX_MESSAGE_SIZE} -
	 ...
	 * 
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#PREFERRED_BLOCK_SIZE} -
	 ...
	 * 
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#MAX_RESOURCE_BODY_SIZE} -
	 ...
	 * 
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#BLOCKWISE_STATUS_LIFETIME} -
	 ...
	 * 
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#BLOCKWISE_STRICT_BLOCK2_OPTION} -
	 ...
	 * If not set, the default value is {@link cf.core.network.config.NetworkConfigDefaults#DEFAULT_BLOCKWISE_STRICT_BLOCK2_OPTION}</li>
	 * </ul>
