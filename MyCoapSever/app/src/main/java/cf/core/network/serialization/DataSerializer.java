...
import cf.elements.util.DatagramWriter;

import static cf.core.coap.CoAP.MessageFormat.OPTION_DELTA_BITS;
import static cf.core.coap.CoAP.MessageFormat.OPTION_LENGTH_BITS;
import static cf.core.coap.CoAP.MessageFormat.PAYLOAD_MARKER;
