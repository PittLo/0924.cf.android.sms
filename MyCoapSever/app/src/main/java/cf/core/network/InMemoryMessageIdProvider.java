...
public class InMemoryMessageIdProvider implements MessageIdProvider {
	 ...
	 * <ul>
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#MID_TRACKER}
	 ...
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#MID_TRACKER_GROUPS}
	 ...
	 * is used.</li>
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#EXCHANGE_LIFETIME}
	 * - each (group of a) message ID returned by <em>getNextMessageId</em> is
	 * marked as <em>in use</em> for this amount of time (ms).</li>
	 * <li>{@link cf.core.network.config.NetworkConfig.Keys#USE_RANDOM_MID_START}
