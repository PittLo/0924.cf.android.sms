...
import cf.elements.util.StandardCharsets;

import static cf.core.coap.CoAP.MessageFormat.EMPTY_CODE;
import static cf.core.coap.CoAP.MessageFormat.REQUEST_CODE_LOWER_BOUND;
import static cf.core.coap.CoAP.MessageFormat.REQUEST_CODE_UPPER_BOUND;
import static cf.core.coap.CoAP.MessageFormat.RESPONSE_CODE_LOWER_BOUND;
import static cf.core.coap.CoAP.MessageFormat.RESPONSE_CODE_UPPER_BOUND;
...
public final class CoAP {
	...
	/** The TLS protocol */
	public static final String PROTOCOL_UDP_SMS = "UDP";
	...
	public static String getSchemeForProtocol(final String protocol) {
		...
		}else if (PROTOCOL_UDP_SMS.equalsIgnoreCase(protocol)) {
			return COAP_URI_SCHEME;
		}
	...
	public static String getProtocolForScheme(final String scheme) {
		if (COAP_URI_SCHEME.equalsIgnoreCase(scheme)) {
			...
			return PROTOCOL_TLS;
		}else if (PROTOCOL_UDP_SMS.equalsIgnoreCase(scheme)) {
			return COAP_URI_SCHEME;
		}
